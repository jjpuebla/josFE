  ...
  try {
    for (let doc of docsToCheck) {
      ...
      if (res.message === false) {
        frappe.msgprint(__('⚠️ PE {0} ya tiene documentos emitidos. No se puede eliminar, solo desactivar.', [doc.emission_point_code]));
        console.log("[josfe:delete-guard] ❌ Blocked delete for PE", doc.emission_point_code);
        return false; // block entire delete
      }
    }
